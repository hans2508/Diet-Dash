...
public class InputMenuLunch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((TextView) header.findViewById(R.id.txtHeader)).setText("MENU MAKAN SIANG PILIHANMU");
    ...
    private void getAllWidgets(View view) {
                    ...
                    builderSingle.setAdapter(
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    dbHelper.addInputMakanan(userEmail, date, food, "Lunch");
                                    getAllWidgets(rootView);
                                }
                            });
        ...
        listMakanan = dbHelper.getInputMakanan(userEmail, date, "Lunch");
        listRow = dbHelper.getRowID(userEmail, date, "Lunch");
