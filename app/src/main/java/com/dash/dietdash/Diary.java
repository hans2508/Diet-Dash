...
public class Diary extends AppCompatActivity {
    ...
    private void showList() {
        ...
        for (int i = 0; i < listPressure.size(); i++) {
            System.out.println("PRESSURE : " + listPressure.get(i).getSystolic() + " " + listPressure.get(i).getDiastolic() + " " +
                    listPressure.get(i).getDate() + " " + listPressure.get(i).getSystolicPrev() + " " +
                    listPressure.get(i).getDiastolicPrev() + " " + listPressure.get(i).getDatePrev());
        }
...
//        }
        ...
        PressureListAdapter adapter = new PressureListAdapter(Diary.this, listPressure);
