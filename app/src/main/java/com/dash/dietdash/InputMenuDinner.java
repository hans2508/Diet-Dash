...
public class InputMenuDinner extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((TextView) header.findViewById(R.id.txtHeader)).setText("MENU MAKAN MALAM PILIHANMU");
    ...
    private void getAllWidgets(View view) {
                    ...
                    builderSingle.setAdapter(
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    dbHelper.addInputMakanan(userEmail, date, food, "Dinner");
                                    getAllWidgets(rootView);
                                }
                            });
        ...
        listMakanan = dbHelper.getInputMakanan(userEmail, date, "Dinner");
        listRow = dbHelper.getRowID(userEmail, date, "Dinner");
