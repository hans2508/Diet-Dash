...
public class UsersProfileDay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridViewAdapter gridViewAdapter = new GridViewAdapter(UsersProfileDay.this, R.layout.grid_view_item, dayList);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
                ...
                int day = d.getDay();
                Intent intent = new Intent(UsersProfileDay.this, UsersProfileDetail.class);
